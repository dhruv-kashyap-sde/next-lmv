...
export const metadata = {
  title: "Contact Us",
  description:
    "Get in touch with Loot My Vouchers for support, feedback, or questions about vouchers and deals. Our team is available 24/7 to help you save money with genuine discount codes.",
  keywords: [
    "contact lmv",
    "customer support",
    "voucher help",
  ...
  openGraph: {
    ...
    description:
      "Need help with vouchers or have feedback? Contact our support team. We're here 24/7 to assist you with any questions.",
    type: "website",
  },
  twitter: {
    ...
    title: "Contact Us - Loot My Vouchers",
    description:
      "Get in touch with us for support, feedback, or questions. Available 24/7 to help you.",
  },
  alternates: {
    canonical: "/contact",
  },
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      link: "https://github.com/dhruv-kashyap-sde/",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/dhruv-kashyap-a5a006250",
    },
    {
      icon: Instagram,
      label: "Instagram",
      link: "https://www.instagram.com/_dhruv.kashyap_?igsh=N213ZjRxMDNwbW02",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 md:h-full">
          ...
          <div className="w-full md:w-1/2 h-full ">
            <div className="relative bg-white/5 backdrop-blur-sm border rounded-md p-6 md:p-8 h-full overflow-hidden">
              {/* Decorative circles */}
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4 md:gap-6">
            ...
            {/* Social Media Card */}
            <div className="border bg-white/5 backdrop-blur-sm border-primary/50 rounded-md p-4 text-center">
              <h3 className="font-bebas text-2xl md:text-3xl text-primary mb-4">
                Follow Us
              </h3>
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`bg-background hover:bg-primary/30 text-primary p-3 md:p-4 rounded-full transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-lg`}
                    >
